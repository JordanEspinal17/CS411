...
async function handleSearch() {
    ...
    if (movieDetails && movieDetails.title) {
        resultsDiv.innerHTML = `<strong>Movie Details:</strong><br>`;
        resultsDiv.innerHTML += `<strong>Title:</strong> ${movieDetails.title}<br>`;
        resultsDiv.innerHTML += `<strong>Overview:</strong> ${movieDetails.overview}<br>`;
        resultsDiv.innerHTML += `<strong>Release Date:</strong> ${movieDetails.releaseDate}<br>`;
    } else {
